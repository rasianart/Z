...
//     //
//
//     camera = new THREE.PerspectiveCamera(45, 1440 / 777, 1, 4000);
    ...
    for (var i = 0; i < particleCount; i++) {
        ...
        for (var j = i + 1; j < particleCount; j++) {
            ...
            if (dist < effectController.minDistance) {
                ...
                postMessage([positions[vertexpos++], colors[colorpos++], numConnected]);
